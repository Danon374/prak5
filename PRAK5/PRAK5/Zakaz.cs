...
namespace PRAK5
{
    internal class Zakaz
    {
        public void MENU()
        {
            ...
            int menu = 1;
            int index = 0;
            Tortik tortik = new Tortik(0, 0, 0, 0, 0, 0, null);
            ConsoleKey key;
                        ...
                        switch (key)
                        {
                            case ConsoleKey.Enter:
                                ...
                                else if (Pos == 8)
                                {
                                    ...
                                    {
                                        tortik = new Tortik(0, 0, 0, 0, 0, 0, null);
                                        Pos = 3;
                                    }
                                }
                                break;
        ...
        public static void OsnMenu(Tortik tortik)
        {
            Console.Clear();
        ...
        public static void ViborTortika(string[,] prices, string[,] podmenu, int index, int position, Tortik tortik)
        {
            switch (index + 1)
            {
                case 1:
        ...
        {
            File.AppendAllText("C:\\Users\\krist\\source\\repos\\PRAK5", $"\nЗаказ от: {DateTime.Now}\n      Заказ: {all_options}\n      Цена: {AllPrice}");
        }
    }
}
